...
type PostProps = {
  ...
  time?: string;
  variant: "default" | "alt";
  listenOnClick?: (event: React.MouseEvent<HTMLButtonElement>) => void;
  playOnClick?: (event: React.MouseEvent<HTMLButtonElement>) => void;
};
      ...
      <div className="border rounded-2xl bg-white shadow-sm p-4 max-w-md my-4">
        <div className="flex items-start">
          ...
          <div className="flex flex-col justify-start">
            ...
            <button
              className="flex items-center gap-2 bg-[#02C7AD] text-black font-semibold px-3 py-2 rounded-xl w-fit"
  ...
  return (
    <div className="w-[350px] max-w-sm bg-white border border-gray-300 rounded-xl shadow-sm my-4 overflow-hidden mx-2">
      ...
      <div className="flex items-center px-4 pt-3 pb-2">
        ...
        <span className="ml-auto text-sm text-gray-500 border rounded-sm p-1">
          {category}
        </span>
      </div>
